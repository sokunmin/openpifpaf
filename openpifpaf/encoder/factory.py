...
def factory(args, strides):
    # configure Pif
    Pif.side_length = args.pif_side_length  # 4

    # configure Paf
    Paf.min_size = args.paf_min_size  # 3
    Paf.fixed_size = args.paf_fixed_size  # False
    Paf.aspect_ratio = args.paf_aspect_ratio  # 0.0
    # > headnets: [pif, paf], strides: [8,8]
